    ...
    <div class="text-center">
      <div class="flex items-center justify-center">
        <svg
          ...
          class="mr-3"
        >
          <rect y="0.5" width="40" height="3" fill="#FAFAFA" />
        </svg>
...
<!-- <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-2">
        ...
        >
          ...
          >
            <img src="../assets/landing/robust.png" alt="" class="" />
          </div>
        </div>
        <div>
          <h1 class="text-unify-primary text-20px leading-7 font-medium">
            Robust school management system
          </h1>
          <p
            class="mt-35px max-w-400px text-20px leading-7 text-unify-dark-100"
          >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 items-center gap-2">
        ...
        >
          <div
            class="py-3 px-3 bg-[#EBEBEB] inline-block rounded-[22.43px] mt-140px max-w-[256px] max-h-[256px] lg:max-w-[322px] lg:max-h-[322px]"
          >
            <img src="../assets/landing/robust.png" alt="" />
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-rows-2 md:grid-cols-2 items-center gap-2">
        <div>
          <h1 class="text-unify-primary text-20px leading-7 font-medium">
